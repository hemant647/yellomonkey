    ...
    <footer class="bg-darker pt-16 pb-8 border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 border-b border-white/10 pb-16">
                ...
                <!-- Contact Info -->
                <div>
                    <h4 class="text-light font-bold mb-6 font-heading text-xl tracking-wider">Contact Us</h4>
                    <address class="text-muted text-sm not-italic space-y-3">
                        <p>123 Marketing Ave, Suite 100<br>Houston, TX 77002</p>
                        <p><a href="mailto:hello@yellomonkey.com" class="hover:text-primary transition-colors duration-200">hello@yellomonkey.com</a></p>
                        <p><a href="tel:+11234567890" class="hover:text-primary transition-colors duration-200">+1 (123) 456-7890</a></p>
                    </address>
                </div>
            </div>
            ...
            <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-muted text-xs">
                    &copy; 2026 YelloMonkey Labs. All rights reserved.
                </p>
                <div class="flex space-x-6">
                    <a href="#" class="text-muted hover:text-primary transition-colors duration-200">
